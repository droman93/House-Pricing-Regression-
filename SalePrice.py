...
plt.style.use('bmh')  # matplotlib
sns.set_style({'axes.grid':False})  #seaborn
...
'''------------------------------------------ 3.1 Linearity and Outliers Treatment ¶ ------------------------------------------'''
...
'''Drop observations where YearBulit is less than 1900'''
...
'''------------------------------------------ 3.2 Imputing Missing Variables  ------------------------------------------'''
...
df_merged.loc[:,['MSSubClass', 'OverallQual', 'OverallCond', 'MoSold', 'YrSold']] = df_merged.loc[:,
                    ['MSSubClass', 'OverallQual', 'OverallCond', 'MoSold', 'YrSold']].astype('object')
...
'''------------------------------------------ 3.3 Normality And Transformation of Distributions  ------------------------------------------'''
